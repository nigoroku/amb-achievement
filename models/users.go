...
var (
	userAllColumns            = []string{"user_id", "account_name", "email", "password", "role", "last_login_at", "created_by", "created_at", "modified_by", "modified_at", "account_img"}
	userColumnsWithoutDefault = []string{"account_name", "email", "password", "role", "last_login_at", "created_by", "created_at", "modified_by", "modified_at", "account_img"}
